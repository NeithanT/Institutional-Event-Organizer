...
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-04-15T09:00:00', 'Main Auditorium', 'Orientation Day 2026', 'Welcome event for new students with institutional resources overview.', @CategoryAcademic, @OrganizerId, @OrganizerEntityId, 300, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'Research Methods Workshop')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-04-22T14:00:00', 'Building B - Room 204', 'Research Methods Workshop', 'Practical workshop on qualitative and quantitative research methods.', @CategoryAcademic, @OrganizerId, @OrganizerEntityId, 80, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'Spring Cultural Festival')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-05-03T16:00:00', 'Central Plaza', 'Spring Cultural Festival', 'Open festival featuring music, dance, and student art displays.', @CategoryCulture, @OrganizerId, @OrganizerEntityId, 500, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'University Book Fair')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-05-10T10:00:00', 'Library Hall', 'University Book Fair', 'Book fair with publishers, talks, and reading activities.', @CategoryCulture, @OrganizerId, @OrganizerEntityId, 250, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'Interfaculty Soccer Cup')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-05-18T08:30:00', 'Campus Stadium', 'Interfaculty Soccer Cup', 'Tournament between faculty teams with semifinal and final matches.', @CategorySports, @OrganizerId, @OrganizerEntityId, 400, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = '5K Campus Run')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-05-25T07:00:00', 'South Gate', '5K Campus Run', 'Community 5K run with hydration points and medals.', @CategorySports, @OrganizerId, @OrganizerEntityId, 600, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'AI for Education Summit')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-06-05T09:30:00', 'Innovation Center', 'AI for Education Summit', 'Talks and demos on responsible AI applications in education.', @CategoryTech, @OrganizerId, @OrganizerEntityId, 220, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'Cybersecurity Awareness Day')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-06-12T11:00:00', 'Building C - Lab 3', 'Cybersecurity Awareness Day', 'Hands-on sessions on password security and phishing prevention.', @CategoryTech, @OrganizerId, @OrganizerEntityId, 120, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'Community Volunteering Fair')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-06-20T15:00:00', 'North Courtyard', 'Community Volunteering Fair', 'NGOs and student groups present volunteering opportunities.', @CategoryCulture, @OrganizerId, @OrganizerEntityId, 180, 1);
END;

IF NOT EXISTS (SELECT 1 FROM dbo.Event WHERE Title = 'Final Projects Expo')
BEGIN
    INSERT INTO dbo.Event (EventDate, Place, Title, EventDescription, CategoryId, OrganizerId, OrganizerEntityId, AvalaibleEntries, ApprovedState)
    VALUES ('2026-06-28T10:00:00', 'Engineering Pavilion', 'Final Projects Expo', 'Showcase of capstone projects and innovation prototypes.', @CategoryAcademic, @OrganizerId, @OrganizerEntityId, 350, 1);
END;
